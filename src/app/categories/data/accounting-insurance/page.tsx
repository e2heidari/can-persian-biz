...
const AccountingInsurance: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchJSONLengths = async () => {
            ...
            const jsonFiles = ['Accountant.json', 'Insurance.json'] // Replace with your actual JSON file names
...
export default AccountingInsurance
